            ...
            try
            {
                ...
                using (FileStream input = new FileStream(fileLocation, FileMode.Open))
                {
                    ...
                    using (Aes aes = Aes.Create())
                    {
                        ...
                        {
                            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(typeof(Folder));
                            exceptionHandled = false;
                            return (Folder)serializer.Deserialize(cryptoStream);
                        }
                    }
                }
            }
